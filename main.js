...
let DeleteButton = (props) => {
  return h('div', {className: 'flex'}, [
    h('button', {className: 'btn', onClick: () => {
      posts = posts.filter(post => post.title !== props.thispost.title);
      rerender();
    }}, 'Delete this post!'),
  ])
}
  ...
  return h('div', {className: 'flex'}, [
    h('button', {className: 'btn', onClick: () => {
      ...
      let newPosts = posts.map(post => {
        (posts.title === props.thispost.title) ?
...
let PostContent = (props) => {
  return h('div', {}, [
      ...
      h(DeleteButton, {thispost: props}),
      h(Snakify, {thispost: props}),
  ])
}
...
let BuildBlog = () => {
  return h('div', {className: 'flexColumn'}, h(BlogList, {postlist: posts}))
}
